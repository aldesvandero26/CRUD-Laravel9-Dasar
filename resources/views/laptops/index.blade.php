        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <a href="{{ route('laptops.create') }}" class="btn btn-md btn-success mb-3">TAMBAH LAPTOP</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <img src="{{ Storage::url('public/laptops/').$laptop->image }}" class="rounded" style="width: 150px">
                                    </td>
                                    <td>{{ $laptop->nama }}</td>
                                    <td>{{ $laptop->tipe }}</td>
                                    <td>{{ $laptop->harga }}</td>
